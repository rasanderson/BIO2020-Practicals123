...
**If you have already downloaded and installed the 'bio2020' package from the Canvas website then both mosaic and ggformula should already have been installed automatically**. However, if you have not installed bio2020 then you will need to download them before loading them in to the library. 
...
To install the packages you can type the following code directly into the **console**; Note, you should only need to do this if you have **not** installed the 'bio2020' package:
...
# If you have installed the bio2020 package uncomment the following line
# library(bio2020)

# If you have not installed bio2020, load packages
library(mosaic)
library(ggformula)
...
# colours can be specified by name or by hex code (the six-character codes after the # symbols), you can google hex colour picker to help you choose or take them from the colour brewer website linked above
```
