...
gf_col(bv_mean ~ site, fill= ~transect,
  ...
  gf_errorbar((bv_mean - bv_se) + (bv_mean + bv_se) ~ site,
              ...
              gf_theme(theme_classic())
  #, inherit=TRUE) #, 
              #data = bivalves_stats, width = 0.2 , position = position_dodge(0.9), inherit = TRUE)
  



# gf_col(mean_abundance ~ Site, fill = ~ Transect, position = position_dodge(), group = ~ Transect, 
#        data = bivalves_data) %>%
#   gf_labs(x = "Site", y = "Mean abundance per m3") %>%
#   gf_errorbar((mean_abundance - sd_abundance) + (mean_abundance + sd_abundance) ~ Site, 
#               data = bivalves_data, width = 0.2 , position = position_dodge(0.9), inherit = TRUE)
