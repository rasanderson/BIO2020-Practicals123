...
```{r, echo = FALSE}
knitr::include_graphics("images/unset_globals.png")
```
Click on 'OK' or 'Apply' once you have done this.
...
Edit the following code to contain your height, and display the value:
...
### Importing tables of data `r emo::ji("file_folder")`CSV
