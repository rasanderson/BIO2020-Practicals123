...
Sometimes the `bio2020` package does not successfully install (I am a biologist, not a computer programmer!). Don't worry, we can easily work around it:
...
* Second, if you are unable to resolve the problems, issue the following commands to manually install the key packages you need for the first few practicals:
