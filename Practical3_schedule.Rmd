...
You have data which details records of weight,head-body length, skull length, home range and density for species from across several families of the order Carnivora. As usual, copy this into your **`Data`** folder, and import it into R/RStudio using the `read.csv()` function. 
